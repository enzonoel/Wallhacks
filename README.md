...
Power: Single-cell LiPo battery + 5V step-up boost module with isolated power switch

Enclosure: 3D-printed split-body chassis (interlocking lip joint, M3 hardware)
